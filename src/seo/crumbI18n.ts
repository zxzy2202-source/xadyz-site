...
export const CRUMB_I18N: Record<Lang, Record<string, string>> = {
  en: {
    ...
    blank: "Blank",
    printed: "Printed",
    blankThermalRolls: "Blank Thermal Rolls",
    printedThermalRolls: "Printed Thermal Rolls",
    blankThermalLabels: "Blank Thermal Labels",
    printedThermalLabels: "Printed Thermal Labels",
    blankNcrForms: "Blank NCR Forms",
    printedNcrForms: "Printed NCR Forms",
  ...
  ru: {
    ...
    blank: "Пустые",
    printed: "Печатные",
    blankThermalRolls: "Пустые рулоны термобумаги",
    printedThermalRolls: "Рулоны термобумаги с печатью",
    blankThermalLabels: "Пустые термоэтикетки",
    printedThermalLabels: "Термоэтикетки с печатью",
    blankNcrForms: "Пустые NCR-формы",
    printedNcrForms: "Печатные NCR-формы",
  ...
  zh: {
    ...
    blank: "空白",
    printed: "印刷",
    blankThermalRolls: "空白热敏卷",
    printedThermalRolls: "印刷热敏卷",
    blankThermalLabels: "空白热敏标签",
    printedThermalLabels: "印刷热敏标签",
    blankNcrForms: "空白NCR表格",
    printedNcrForms: "印刷NCR表格",
