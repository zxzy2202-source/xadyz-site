...
function SearchPreservingNavigate({ to }: { to: string }) {
...
function createLangRoutes(lang: Lang) {
  ...
  return [
    ...
    <Route key={`${lang}-pos-redir`} path={`${prefix}/pos-thermal-paper`} element={<SearchPreservingNavigate to={`${prefix}/thermal-paper-rolls/pos`} />} />,
    <Route key={`${lang}-atm-redir`} path={`${prefix}/atm-thermal-paper`} element={<SearchPreservingNavigate to={`${prefix}/thermal-paper-rolls/atm`} />} />,
    <Route key={`${lang}-bpa-redir`} path={`${prefix}/bpa-free-thermal-paper`} element={<SearchPreservingNavigate to={`${prefix}/thermal-paper-rolls/bpa-free`} />} />,
    ...
    <Route key={`${lang}-labels-4x6-redir`} path={`${prefix}/thermal-labels-4x6`} element={<SearchPreservingNavigate to={`${prefix}/thermal-labels/4x6`} />} />,
    <Route key={`${lang}-labels-a6-redir`} path={`${prefix}/thermal-labels-a6`} element={<SearchPreservingNavigate to={`${prefix}/thermal-labels/a6`} />} />,
    <Route key={`${lang}-logistics-redir`} path={`${prefix}/logistics-labels`} element={<SearchPreservingNavigate to={`${prefix}/thermal-labels/logistics`} />} />,
    ...
    <Route key={`${lang}-sa-redir`} path={`${prefix}/material-supply/self-adhesive`} element={<SearchPreservingNavigate to={`${prefix}/material-supply/self-adhesive-jumbo-rolls`} />} />,
    <Route key={`${lang}-thermal-redir`} path={`${prefix}/material-supply/thermal-jumbo`} element={<SearchPreservingNavigate to={`${prefix}/material-supply/thermal-jumbo-rolls`} />} />,
    <Route key={`${lang}-ncr-jumbo-redir`} path={`${prefix}/material-supply/ncr-jumbo`} element={<SearchPreservingNavigate to={`${prefix}/material-supply/ncr-jumbo-rolls`} />} />,
    <Route key={`${lang}-ncr-redir`} path={`${prefix}/material-supply/ncr`} element={<SearchPreservingNavigate to={`${prefix}/material-supply/ncr-jumbo-rolls`} />} />,
    ...
    <Route
      ...
      element={<SearchPreservingNavigate to={`${prefix}/manufacturing/packaging-shipping`} />}
    />,
    ...
    <Route key={`${lang}-tender-redir`} path={`${prefix}/request-tender-pack`} element={<SearchPreservingNavigate to={`${prefix}/applications/request-tender-pack`} />} />,
    <Route key={`${lang}-quality-redir`} path={`${prefix}/quality`} element={<SearchPreservingNavigate to={`${prefix}/manufacturing/quality-control`} />} />,
    <Route key={`${lang}-quality-ctrl-redir`} path={`${prefix}/quality-control`} element={<SearchPreservingNavigate to={`${prefix}/manufacturing/quality-control`} />} />,
    <Route key={`${lang}-pkg-redir`} path={`${prefix}/packaging-logistics`} element={<SearchPreservingNavigate to={`${prefix}/resources/packaging-logistics`} />} />,
  ];
}
  ...
  return (
    <Suspense fallback={<PageLoadingFallback />}>
      <Routes>
        ...
        <Route path="/contact" element={<SearchPreservingNavigate to="/en/contact" />} />
        {createLangRoutes('en')}
        {createLangRoutes('ru')}
        {createLangRoutes('zh')}
        <Route path="/zh/thermal-jumbo-rolls" element={<SearchPreservingNavigate to="/zh/material-supply/thermal-jumbo-rolls" />} />
        <Route path="/zh/jumbo-rolls" element={<SearchPreservingNavigate to="/zh/material-supply/thermal-jumbo-rolls" />} />
        <Route path="/zh/self-adhesive-jumbo-rolls" element={<SearchPreservingNavigate to="/zh/material-supply/self-adhesive-jumbo-rolls" />} />
        <Route path="/zh/self-adhesive-sheets" element={<SearchPreservingNavigate to="/zh/material-supply/self-adhesive-sheets" />} />
        <Route path="/zh/ncr-jumbo-rolls" element={<SearchPreservingNavigate to="/zh/material-supply/ncr-jumbo-rolls" />} />
        <Route path="/zh/ncr-sheets" element={<SearchPreservingNavigate to="/zh/material-supply/ncr-sheets" />} />
        <Route path="/ru/jumbo-rolls" element={<SearchPreservingNavigate to="/ru/material-supply/thermal-jumbo-rolls" />} />
        <Route path="/en/jumbo-rolls" element={<SearchPreservingNavigate to="/en/material-supply/thermal-jumbo-rolls" />} />
        <Route path="/ru/contacts" element={<SearchPreservingNavigate to="/ru/contact" />} />
        <Route path="/zh/contacts" element={<SearchPreservingNavigate to="/zh/contact" />} />
        <Route path="/en/contacts" element={<SearchPreservingNavigate to="/en/contact" />} />
