...
export const content: Record<Lang, RequestTenderPackContent> = {
  en: {
    ...
    subtitle: 'Request the documentation set procurement teams need for supplier review, bidding, and project approval.',
    ...
    formSubtitle: "Fill out the form below and we'll prepare the documentation package within 24 hours.",
  ...
  ru: {
    ...
    subtitle: 'Запросите комплект документов, который нужен закупщикам для тендеров, согласования поставщика и проектной оценки.',
    ...
    formSubtitle: 'Заполните форму ниже, и мы подготовим полный комплект документов в течение 24 часов.',
  ...
  zh: {
    ...
    h1: '索取投标资料包',
    subtitle: '申请采购与投标团队需要的整套资质、规格和交付资料，用于供应商审核和项目评估。',
    whatsIncluded: '资料包内容',
    ...
    formTitle: '申请投标资料包',
    formSubtitle: '填写下方表单，我们将在 24 小时内整理并发送完整资料。',
    companyName: '公司名称',
