...
import { ArrowRight, CheckCircle2, Building2, CreditCard, FileText, Lock, Zap, Shield } from 'lucide-react';
import { PageShell } from '@/app/components/PageShell';
import { SEO } from '@/app/components/SEO';
import { PageHero } from '@/app/components/hero/PageHero';
import { PLACEHOLDERS } from '@/app/lib/assets';
import type { PageAssetsConfig } from '@/app/lib/assets';
import { content } from './BankingFinancePage.content';

export const pageAssets: PageAssetsConfig = {
  seoImage: { src: PLACEHOLDERS.hero.application, alt: "Banking thermal paper and NCR" },
  hero: {
  ...
  gallery: [
    { src: PLACEHOLDERS.gallery.g1, alt: "Banking thermal paper" },
    { src: PLACEHOLDERS.gallery.g2, alt: "Financial NCR forms" },
...
interface BankingFinancePageProps {
  lang: 'en' | 'ru' | 'zh';
}

export const BankingFinancePage: React.FC<BankingFinancePageProps> = ({ lang }) => {
