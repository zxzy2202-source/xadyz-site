...
import { ArrowRight, CheckCircle2, ShoppingCart, Tag, Receipt, Users, Zap, Shield } from 'lucide-react';
import { PageShell } from '@/app/components/PageShell';
import { SEO } from '@/app/components/SEO';
import { PageHero } from '@/app/components/hero/PageHero';
import { PLACEHOLDERS } from '@/app/lib/assets';
import type { PageAssetsConfig } from '@/app/lib/assets';
import { content } from './SupermarketsPage.content';

export const pageAssets: PageAssetsConfig = {
  seoImage: { src: PLACEHOLDERS.hero.application, alt: "Supermarket thermal products" },
  hero: {
  ...
  gallery: [
    { src: PLACEHOLDERS.gallery.g1, alt: "Supermarket thermal paper" },
    { src: PLACEHOLDERS.gallery.g2, alt: "Retail chain thermal products" },
...
export const SupermarketsPage: React.FC<SupermarketsPageProps> = ({ lang }) => {
      ...
      <PageShell lang={lang} hero={(
        <div className="-mt-32 pt-32 mb-20">
          <PageHero
            ...
            placeholderKey="supermarkets_hero"
          />
        </div>
      )}>
          {/* 02: Overview Section */}
