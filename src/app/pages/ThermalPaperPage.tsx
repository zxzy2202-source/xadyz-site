  ...
  const heroContent = (
    <PageHero
      ...
      primaryCta={{
        ...
        href: getContactInquiryUrl(lang, 'thermal_paper_rolls', 'quote'),
      }}
      secondaryCta={{
        label: lang === 'zh' ? '申请样品' : lang === 'ru' ? 'Запросить образцы' : 'Request Samples',
        href: getContactInquiryUrl(lang, 'thermal_paper_rolls', 'sample'),
      }}
    ...
    <>
      ...
      <PageShell lang={lang} hero={heroContent}>
              ...
              {t.productTypes.types.map((type) => (
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    <Link 
                      to={getContactInquiryUrl(lang, 'thermal_paper_rolls', 'sample')}
                    ...
                    <Link 
                      to={getContactInquiryUrl(lang, 'thermal_paper_rolls', 'quote')}
        ...
        <ProductPageCta
          ...
          primaryLink={getContactInquiryUrl(lang, 'thermal_paper_rolls', 'quote')}
          secondaryLink={getContactInquiryUrl(lang, 'thermal_paper_rolls', 'sample')}
        />
      </PageShell>
    </>
  );
